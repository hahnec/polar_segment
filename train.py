            ...
            if cfg.logging and branch_type == 'test':
                for bidx in range(truth.shape[0]):
                    ...
                    if cfg.data_subfolder.__contains__('raw'):
                        ...
                        azimuth_model = LuChipmanModel(feature_keys=['linr', 'azimuth'], norm_opt=1)
                        ...
                        # tbd: adjust fiber plot
                        fiber_img = plot_fiber(raw_azimuth=vars[0][1]*180, linr=vars[0][0], mask=mask, intensity=vars[2])
                        wandb.log({
