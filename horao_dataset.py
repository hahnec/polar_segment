...
if __name__ == '__main__':
    ...
    for data_type in ['polarimetry', 'raw_data']:
        ...
        train_set = HORAO(base_dir, ['train2_b_imbalance.txt'], bg_opt=bg_opt, class_num=4, data_subfolder=data_type, keys=feat_keys, wlens=[550], transforms=transforms)
        ...
        test_set = HORAO(base_dir, ['test2_b_imbalance.txt'], bg_opt=bg_opt, class_num=4, data_subfolder=data_type, keys=feat_keys, wlens=[550], transforms=transforms)
