...
if __name__ == '__main__':
    ...
    for data_type in ['polarimetry', 'raw_data']:
        ...
        train_set = HORAO(base_dir, ['k1_d_imbalance.txt', 'k2_d_imbalance.txt'], bg_opt=bg_opt, class_num=4, data_subfolder=data_type, keys=feat_keys, wlens=[550], transforms=transforms)
        valid_set = HORAO(base_dir, ['val2_d.txt'], bg_opt=bg_opt, class_num=4, data_subfolder=data_type, keys=feat_keys, wlens=[550], transforms=transforms)
        test_set = HORAO(base_dir, ['k3_d_imbalance.txt'], bg_opt=bg_opt, class_num=4, data_subfolder=data_type, keys=feat_keys, wlens=[550], transforms=transforms)
