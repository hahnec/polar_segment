...
#    python train.py group=$1_rotaflip model=unet levels=1 kernel_size=0 k_select=$k_select rotation=45 flips=1
    python train.py group=$1_rotaflip model=unet levels=0 kernel_size=0 k_select=$k_select rotation=45 flips=1
