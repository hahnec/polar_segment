...
def draw_segmentation_imgs(imgs, preds, truth, bidx=0, alpha=0.3):
    ...
    colors = ['gray', 'blue', 'green', 'orange', 'red'][:n_channels]
    ...
    frame_pred = draw_segmentation_masks(img, masks=combined_masks[0], alpha=alpha, colors=colors)
    frame_mask = draw_segmentation_masks(img, masks=combined_masks[1], alpha=alpha, colors=colors)
