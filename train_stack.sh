# MLP
python train.py model=mlp lr=1e-3 levels=1 kernel_size=0 wlens='[550]'
python train.py model=mlp lr=1e-3 levels=3 kernel_size=0 wlens='[550]'
python train.py model=mlp lr=1e-3 levels=3 kernel_size=0 method=averaging wlens='[550]'
python train.py model=mlp lr=1e-3 levels=1 kernel_size=0 wlens='[550]'
python train.py model=mlp lr=1e-3 levels=1 kernel_size=3 wlens='[550]'
python train.py model=mlp lr=1e-3 levels=3 kernel_size=3 wlens='[550]'
python train.py model=mlp lr=1e-3 levels=3 kernel_size=3 activation=leaky wlens='[550]'
python train.py model=mlp lr=1e-3 levels=5 kernel_size=3 wlens='[550]'
python train.py model=mlp lr=1e-3 levels=5 kernel_size=0
python train.py model=mlp lr=1e-3 levels=5 kernel_size=3
# U-net
